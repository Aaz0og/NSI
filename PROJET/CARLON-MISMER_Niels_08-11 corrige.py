""" Il faut tâcher de vous rapprocher du cahier des charges pour la version finale du projet:
    - la programmation objet est nécessaire; vous devez vous appuyer sur le travail d'analyse fonctionnelle produit en classe
    - aucune animation n'est attendue : revenir à Tkinter ne vous fera pas perdre de temps, mais vous permettra de rentrer dans les attentes de ce travail
    - on peut se contenter de l'affichage de l'affichage de quelques positions successives de la bulle, illustrant le bon fonctionnement de chacun des rebonds
Je discute avec Mehdi ce matin.
J'espère vous voir également.
"""
